namespace Lab6
{
    public class Blue
    {
        public void Task1(ref int[,] matrix)
        {
            ...
            int maxind = FindDiagonalMaxIndex(matrix);
        ...
        public int Task2(int[,] A, int[,] B, int[,] C)
        {
            ...
            // code here
            double srznA = GetAverageExceptEdges(A);
            double srznB = GetAverageExceptEdges(B);
            double srznC = GetAverageExceptEdges(C);
