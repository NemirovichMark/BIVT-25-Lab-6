            ...
            if (n == m)
            {
                ...
                for (int i = 0; i < n - 1; i++)
                {
                    for (int j = 0; i < n - 1 - i; j++)
                    {
                        ...
                        {
                            (matrix2[j], matrix2[j + 1]) = (matrix2[j + 1], matrix2[j]);
                        }
                    }
                }
                for (int i = 0; i < matrix.GetLength(0); i++)
                {
                    matrix[i, i] = matrix2[i];
                }
            }
        }
            ...
            if (n == m)
            {
                ...
                for (int i = 0; i < n - 1; i++)
                {
                    for (int j = 0; i < n - 1 - i; j++)
                    {
                        if (matrix2[j] > matrix2[j + 1])
                        {
                            (matrix2[j], matrix2[j + 1]) = (matrix2[j + 1], matrix2[i]);
                        }
                    }
                }
                for (int i = 0; i < n; i++)
