diff --git a/Lab6/Green.cs b/Lab6/Green.cs
index 16b248c36be4ebf1b1f6d4b6fd672f314b56ad5e..64ca7bb3a5348abe8abed740756134d28017deb8 100644
--- a/Lab6/Green.cs
+++ b/Lab6/Green.cs
@@ -1,97 +1,595 @@
-﻿using System.Linq;
...
+                }
+
+                tail = tail.OrderByDescending(x => x).ToArray();
+                for (int j = 0; j < length; j++)
+                {
+                    matrix[i, maxIndex + 1 + j] = tail[j];
+                }
